...
// const showLoadingMessage = async (channel, text) => {
//   const loadingMessage = await channel.send(`${text} ⌛`);
...
client.on("ready", (client) => {
  ...
  client.user.setActivity(`With Your Feeling`, Discord.ActivityType.Playing);
...
client.on("messageCreate", async (message) => {
  ...
  //const loadingMessage = await showLoadingMessage(message.channel, "Loading");
